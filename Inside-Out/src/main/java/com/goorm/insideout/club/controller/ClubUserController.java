...
public class ClubUserController {
	...
	@Operation(summary = "동아리 멤버 탈퇴 API", description = "동아리 멤버가 탈퇴하는 API 입니다.")
	...
	@Operation(summary = "동아리 멤버 승인 API", description = "동아리 멤버 지원을 승인하는 API 입니다.")
	...
	@Operation(summary = "동아리 멤버 거절 API", description = "동아리 멤버 지원을 거절하는 API 입니다.")
	...
	@Operation(summary = "동아리 멤버 지원 목록 조회 API", description = "동아리 멤버 지원자 목록을 조회하는 API 입니다.")
